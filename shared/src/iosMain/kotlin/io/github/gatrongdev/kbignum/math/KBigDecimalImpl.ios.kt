...
actual class KBigDecimalImpl actual constructor(value: String) : KBigDecimal {
    ...
    actual companion object {
        ...
        private fun formatForScale(str: String, targetScale: Int?): String {
    ...
    actual override fun divide(
        ...
        if (mode == 7) {
            ...
            val highPrecisionHandler = NSDecimalNumberHandler.decimalNumberHandlerWithRoundingMode(
                NSRoundingMode.NSRoundPlain,
                (scale + 10).toShort(),
                true, true, true, true
            )
    ...
    private fun formatToScale(str: String, scale: Int): String {
        val decimalIndex = str.indexOf('.')
