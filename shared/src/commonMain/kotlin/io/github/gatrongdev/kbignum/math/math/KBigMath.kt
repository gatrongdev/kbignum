...
object KBigMath {
     ...
     */
    fun max(a: KBigDecimal, b: KBigDecimal): KBigDecimal = a.max(b)
    fun max(a: KBigInteger, b: KBigInteger): KBigInteger = a.max(b)
    
    /**
     * Calculate minimum of two values
     */
    fun min(a: KBigDecimal, b: KBigDecimal): KBigDecimal = a.min(b)
    fun min(a: KBigInteger, b: KBigInteger): KBigInteger = a.min(b)
}
